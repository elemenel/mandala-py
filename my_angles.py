...
def get_multiples():
    ...
    print(multiples)
    Lg.logger.info(
        f"my_angles.py:The list of multiples using {multiple} for the multiplier to a maximum of {maximum} for {my_number} is: {multiples}"
    )
...
def get_my_multiples():
    ...
    my_multiples = [
        ...
        for my_number in np.arange(
            float(my_multiples_number), my_multiples_key, max_value
        )
...
def get_sequence_of_values():
    ...
    key = my_value * 3
    sequence_values = [
        value for value in np.arange(my_value, max_value, key) if value % (180) != 0
    ]
...
def pick_angles():
    ...
    i_angle_float = [
        angle
        for angle in np.arange(float(angle_min), float(angle_max), float(key))
        if angle % (180) != 0
    ]  # +[180] #+ multiples #1188, 1584, 1980, 2376, 2772, 3168, 3564]
...
Lg.logger.info(
    f"my_angles.py: The Automated Set of Angles to be Drawn as for the selected mandala is: {i_angle_float}"
)
Lg.logger.info(
    f"my_angles.py: The Automated Set of Angles to be Drawn as integers are:  {integer_values}"
)
Lg.logger.info(
    f"my_angles.py: The Automated Set of Angles to be Drawn as float numbers are:  {float_values}"
)
Lg.logger.info(
    f"my_angles.py: The Automated Set of Angles to be Drawn  rounded are:  {valuesRounded}"
)
Lg.logger.info(
    "............................................................................................................................................"
)
Lg.logger.info(
    f"my_angles.py: The number of Automated Angle Generator elements for rounded elements is: {len(valuesRounded)}"
)
Lg.logger.info(
    f"my_angles.py: The number of Automated Angle Generator elements for float values is: {len(float_values)}"
)
Lg.logger.info(
    "*******************************************************************************************************"
)
