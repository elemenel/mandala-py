...
if sys.platform.startswith("linux"):
    ...
    my_audio_backup_folder = (
        "/mnt/fe9f7833-9c10-449c-bf09-a8dfa3d54adc/AudioClipsPython/"
    )
...
def make_reverse_png_folder():
    ...
    Lg.logger.info(
        f"FileScripts:New folder:  {reverse_png_folder} has been created @ {Tm.my_time}"
    )
    Lg.logger.info(
        f"FileScripts:{reverse_png_folder} has been emptied. The folder is now ready for new content @ {Tm.my_time}."
    )
...
def make_png_folder():
    ...
    Lg.logger.info(
        f"FileScripts:New folder: {png_folder} has been created @ {Tm.my_time} "
    )
    Lg.logger.info(
        f"FileScripts:{png_folder} has been emptied. The folder is now ready for new content @ {Tm.my_time}."
    )
...
def move_pngs():
    ...
    Lg.logger.info(
        f"FileScripts:Image .png files have been moved to {my_thumbs} @ {Tm.my_time}"
    )
...
def move_jpegs():
    ...
    Lg.logger.info(
        f"FileScripts:The jpeg files were successfully moved to {final_thumbs} @ {Tm.my_time} ."
    )
...
def move_all():
    ...
    Lg.logger.info(
        f"FileScripts:Video .avi files have been moved to /Videos/@ {Tm.my_time} "
    )
    ...
    Lg.logger.info(
        f"FileScripts:Video .mp4 files have been moved to /Videos/@ {Tm.my_time} "
    )
    ...
    Lg.logger.info(
        f"FileScripts:Video .webm files have been moved to /Videos/@ {Tm.my_time} "
    )
    ...
    Lg.logger.info(
        f"FileScripts:Image .png files have been moved to /Thumbs/@ {Tm.my_time} "
    )
    ...
    Lg.logger.info(
        f"FileScripts:Image .jpeg files have been moved to /home/sels/Pictures/Mandala Final Thumbs/@ {Tm.my_time} "
    )
    Lg.logger.info(
        "================================================================================"
    )
...
def clear_thumbs():
    Lg.logger.info(
        f"FileScripts:Preparing to empty the Thumbs folder @ {Tm.my_time} ......."
    )
...
def sync_full_vids():
    # Sync Videos
    Lg.logger.info(
        f"FileScripts:Working on sync of MandalaMaker Full Vids folders @ {Tm.my_time}"
    )
...
def sync_module_folders():
    ...
    Lg.logger.info(
        f"FileScripts: Finished Sync of Modules folders to {target_path_a} @ {Tm.my_time}"
    )
    dirsync.sync(source_path_a, target_path_shared_modules, "sync", create=True)
    Lg.logger.info(
        f"FileScripts: Finished Sync of Modules folders to {target_path_shared_modules} @ {Tm.my_time}"
    )
    dirsync.sync(source_path_a, target_path_b, "sync", create=True)
    Lg.logger.info(
        f"FileScripts: Finished Sync of Modules folders to {target_path_b} @ {Tm.my_time}"
    )
    dirsync.sync(source_path_a, target_path_u, "sync", create=True)
    Lg.logger.info(
        f"FileScripts: Finished Sync of Modules folders to {target_path_u} @ {Tm.my_time}"
    )
    Lg.logger.info(
...
def sync_audio_clips():
    ...
    Lg.logger.info(
        f"FileScripts: Finished  Sync of Audio Clips folders to {target_path_shared_audio} @ {Tm.my_time}"
    )
    dirsync.sync(source_path_audio, target_path_back_up_audio, "sync", create=True)
    Lg.logger.info(
        f"FileScripts: Finished Sync of Audio Clips folders to {target_path_back_up_audio} @ {Tm.my_time}"
    )
    dirsync.sync(source_path_audio, target_path_u, "sync", create=True)
    Lg.logger.info(
        f"FileScripts: Finished Sync of Audio Clips folders to {target_path_u} @ {Tm.my_time}"
    )
    Lg.logger.info(
...
def sync_images():
    ...
    Lg.logger.info(
        f"FileScripts: Finished Sync of Image folders to {target_path_shared_images} @ {Tm.my_time}"
    )
    Lg.logger.info(
...
def code_backup():
    ...
    Lg.logger.info(
        f"FileScripts:Python Code files have been backed up to MandalaMakerBackup pendrive @ {Tm.my_time}"
    )
...
def make_daily_activities_log():
    ...
    def create_log_file(module_name):
        ...
        log_file_path = os.path.join(
            os.getcwd(),
            f"/home/sels/Modules/MandalaMaker/Daily_Logs, {t.folder_name}.log",
        )
...
def move_thumbs():
    ...
    # Print a message to confirm that the files were moved
    Lg.logger.info(
        f"FileScripts:The Thumb files were successfully moved to the destination directory @ {Tm.my_time}."
    )
...
def move_pics():
    ...
    move_jpgs()
    Lg.logger.info(
        f"FileScripts:Image .png files have been moved to /Thumbs/Output/@ {Tm.my_time} "
    )
    Lg.logger.info(
        f"FileScripts:Image .jpg files have been moved to /Mandala Final Thumbs/@ {Tm.my_time} "
    )
...
def update_all():
    ...
    current_path()
    Lg.logger.info(
        f"FileScripts:Pics have been moved to Pictures folder and Dropbox has been updated @ {Tm.my_time} "
    )
...
def make_file_folder():
    Lg.logger.info(
        f"FileScripts:Starting make_file_folder() @ {Tm.my_time} ..................."
    )
    ...
    Lg.logger.info(
        f"FileScripts:New temp directory /Looped_Pics/Thumbs/{t.folder_name} has been created @ {Tm.my_time}"
    )
