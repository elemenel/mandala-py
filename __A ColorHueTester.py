...
r = turtle.numinput(
    "Red", "Enter number value for Red Hue:", str(122)
)  # Default is 122
g = turtle.numinput(
    "Green", "Enter number value for Green Hue:", str(133)
)  # Default is 133
b = turtle.numinput(
    "Blue", "Enter number value for Blue Hue:", str(215)
)  # Default is 215
...
my_hue.pendown()
my_hue.write(
    str("R:                 G:                  B:  "), font=("Garamond", 10, "bold")
)
...
my_hue.pendown()
my_hue.write(
    "This is the composite hue for colors "
    + str(R)
    + ", "
    + str(G)
    + ", "
