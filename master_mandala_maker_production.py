...
def glorious_mandala_a():  # Based on Awesome Manadala
    ...
    for a.i in range(len(a.i_angle)):
        ...
        for count in range(int(my_range * 0.66)):
            pa = green_hue_pen
            pb = gold_hue_pen
            if count <= 255:
            ...
            for count in range(my_range):
                ...
                if my_loops == 2:
                    ...
                    gold_hue_pen.pencolor(
                        my_loops * 80, my_loops * count % 255, my_range - count % 152
                    )
                    gold_hue_pen.pensize(count / my_pensize / my_loops)
                    ...
                    pick_green()
                    gold_hue_pen.pencolor(
                        my_loops * count % 255, my_loops * 80, my_range - count % 127
                    )
                    gold_hue_pen.pensize(count / my_pensize / my_loops)
...
def spectrum_mandala():
    ...
    for a.i in range(len(a.i_angle)):
        ...
        Lg.logger.info(
            f"{my_script}:Third pass starting @ {Tm.my_time}"
...
def pick_mandala_script():
    global my_script, script
    Lg.logger.info(
        f"{my_script}:Preparing to run {my_script_count} scripts @ {Tm.this_time}"
    )
